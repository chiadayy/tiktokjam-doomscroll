...
const RULES: IntentRule[] = [
  ...
  },
  {
    ...
    patterns: [
      ...
      /\b(?:skip|comment out|delete|remove|weaken)\b[^.\n]{0,25}\b(?:the )?(?:failing )?(?:test|assertion)s?\b[^.\n]{0,30}\b(?:so (?:it|they|the (?:suite|build)) pass|to (?:make|get) (?:it|them|ci) (?:green|pass))/i,
    ],
  },
];
